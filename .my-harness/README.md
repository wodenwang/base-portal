...
- v0.3.0 implementation plan：`docs/superpowers/plans/2026-06-20-v0.3.0-embedded-sso-workspace.md`
- v0.3.0 local verification：`docs/verification/2026-06-20-v0.3.0-local-verification.md`
- v0.3.0 browser verification：`docs/verification/2026-06-20-v0.3.0-browser-verification.md`
- v0.3.0 visual QA：`docs/qa/2026-06-20-v0.3.0-visual-qa.md`
...
- v0.1.2 Superpowers plan：`docs/superpowers/plans/2026-06-19-v0.1.2-ux-hardening.md`
- v0.1.2 发布记录：`docs/release-v0.1.2.md`
- v0.1.2 review：`docs/reviews/2026-06-19-v0.1.2-pre-landing-review.md`
- v0.1.2 Ship preflight：`docs/ship/2026-06-19-v0.1.2-ship-preflight.md`
- v0.1.2 验证记录：`docs/verification/2026-06-19-v0.1.2-production-deploy.md`
